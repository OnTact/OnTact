...
CREATE TABLE connections (id serial primary key, initiator_id integer, receiver_id integer, created_at timestamp, updated_at timestamp, pending boolean, connection_type varchar(255), is_connected boolean, additional_info text
);
